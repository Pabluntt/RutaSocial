...
// GetRoutesByInstitution maneja la solicitud para obtener rutas por institución.
func (r *routeController) GetRoutesByInstitution(c *gin.Context) {
	r.routeUseCase.GetRoutesByInstitution(c)
}
